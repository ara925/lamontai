...
-- AddForeignKey
ALTER TABLE "Article" ADD CONSTRAINT "Article_contentPlanId_fkey" FOREIGN KEY ("contentPlanId") REFERENCES "ContentPlan"("id") ON DELETE SET NULL ON UPDATE CASCADE;
