    ...
    const fetchUserData = async () => {
      try {
        ...
        if (userData) {
          ...
          if (!userData.settings?.websiteUrl) {
            console.error('Website URL not set, redirecting to website URL page');
            router.push('/onboarding/website-url');
            return;
          }
        } else {
