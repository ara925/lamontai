          ...
          <div className="max-w-xl mb-12">
            <Link href="/" className="inline-block mb-6">
              <span className="text-2xl font-bold text-white">
                Lamont<span className="text-primary">.ai</span>
              </span>
            </Link>
            <p className="text-gray-400 leading-relaxed">
              Generate high-quality, SEO-optimized content that ranks
              on Google. Our AI is specialized in creating articles that
      ...
      <div className="border-t border-gray-800">
        <Container>
          <div className="py-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm">
              © {new Date().getFullYear()} Lamont.ai. All rights reserved.
            </p>
